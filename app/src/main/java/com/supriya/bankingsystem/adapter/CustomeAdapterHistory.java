...
import com.supriya.bankingsystem.activity.CustomerHistoryList;
...
public class CustomeAdapterHistory extends RecyclerView.Adapter<ViewHolder> {
    ...
    CustomerHistoryList HistoryList;
    List<model> modelList;
    Context context;

    TextView mTransc_status;

    public CustomeAdapterHistory(CustomerHistoryList historyList, List<model> modelList) {
